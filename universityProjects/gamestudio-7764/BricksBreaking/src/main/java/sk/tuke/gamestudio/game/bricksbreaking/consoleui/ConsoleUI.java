...
//        }
    ...
    private void printStats() {
        ...
        if(inputString == null){
            ...
            System.out.println(ratingService.getRating("brick breaking", player));
        }else if(inputString.equals("A")){
            System.out.println(ratingService.getAverageRating("brick breaking"));
        }else if(inputString.equals("C")){
            List<Comment> comments = commentService.getComments("brick breaking");
            int i = 0;
            ...
            List<Score> topScores = scoreService.getTopScores("brick breaking");
            int i = 0;
    ...
    private String getInputString() {
        ...
        System.out.print(   "[R] Get ratings\n" +
                            "[A] Get average rating\n" +
                            "[C] Get comments\n" +
                            "[T] Get top scores\n" +
                            "Want to print some stats? Enter the character: ");
        String str = sc.nextLine();//reads string
        if(str == null){
            return null;
        }
        str = str.trim();
        Pattern INPUT_PATTERN = Pattern.compile("R|A|C|T");
    ...
    private String writeComment() {
        ...
        str = str.trim();
        Pattern INPUT_PATTERN = Pattern.compile("^.{1,30}$");
        var matcher = INPUT_PATTERN.matcher(str);
        if (matcher.matches()) {
            return str;
        }
